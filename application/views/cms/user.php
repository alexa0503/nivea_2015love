								...
								<tr>
									<td colspan="<?php echo count($theads);?>">
										<div class="bulk-actions align-left">
											...
											<a href="<?php echo site_url('index/export').'&table=user';?>" class="button" download="<?php echo site_url('index/export').'&table=user';?>">导出数据</a>
											<a href="<?php echo site_url('index/clear&table=user');?>" class="button">清空数据</a>
											-->
										</div>
